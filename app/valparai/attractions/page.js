            ...
            {attractions.slice(0, 5).map((item, i) => (
              <SwiperSlide key={i}>
                <div className="relative aspect-[3/4] rounded-[3rem] overflow-hidden group">
                  <Image quality={100}  width={100}  height={100} src={item.image} className="object-cover w-full h-full transition-transform duration-700 group-hover:scale-110" alt={item.title} />

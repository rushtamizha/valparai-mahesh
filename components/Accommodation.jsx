              ...
              <SwiperSlide key={room.id}>
                <div className="overflow-hidden bg-white border border-slate-100 rounded-[2.5rem] group">
                  <div className="relative overflow-hidden h-72">
                    <Image width={100}  height={100} src={room.images[0]} className="object-cover w-full h-full transition-transform duration-700 group-hover:scale-110" alt={room.name} />
                  </div>
                  <div className="p-7">
